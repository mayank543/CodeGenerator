...
export const History: React.FC<HistoryProps> = ({ items, onSelect, onToggleFavorite }) => {
    ...
    return (
        <div className="w-full bg-neutral-50 dark:bg-neutral-900 border-r border-neutral-200 dark:border-neutral-800 flex flex-col h-full transition-colors duration-300">
            <div className="p-4 border-b border-neutral-200 dark:border-neutral-800">
                <h2 className="text-sm font-semibold text-neutral-500 dark:text-neutral-400 uppercase tracking-wider mb-3">History</h2>
                <input
                    type="text"
                    value={search}
                            ...
                            <li key={item.id} className="group relative">
                                ...
                                >
                                    <div className="flex justify-between items-start mb-1">
                                        <p className="text-sm text-neutral-700 dark:text-neutral-300 truncate pr-6 group-hover:text-neutral-900 dark:group-hover:text-white font-medium">
                                            {item.prompt}
                                        </p>
                                    </div>
                                ...
                                <button
                                    ...
                                    className={`absolute top-4 right-2 p-1 rounded-full hover:bg-neutral-200 dark:hover:bg-neutral-700 transition-colors ${item.isFavorite ? 'text-yellow-500' : 'text-neutral-400 dark:text-neutral-600 hover:text-neutral-600 dark:hover:text-neutral-400'
                                        }`}
